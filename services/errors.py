...
class InsufficientFundsError(ServiceError):
    ...
    def __init__(self, message: str = "Недостаточно средств", required: float = 0, balance: float = 0):
...
class LimitExceededError(ServiceError):
    ...
    def __init__(self, message: str = "Лимит исчерпан"):
...
class ForbiddenError(ServiceError):
    ...
    def __init__(self, message: str = "Операция запрещена"):
